from flask import abort, Blueprint, current_app, flash, render_template, redirect
...
def single_news(news_id):
    ...
    news_list = News.query.filter(News.id != news_id, News.text.is_not(None)).order_by(News.published.desc()).all()
